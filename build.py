...
LIGHTBOX = '''<div class="lightbox" id="lightbox">
  ...
  <div class="lightbox-img-wrap" onclick="lightboxClickNav(event)"><img id="lightbox-img" alt=""><span class="lightbox-caption" id="lightbox-caption"></span></div>
</div>'''
...
(function(){
  function estPhoto(e){var t=e.target;return t&&t.tagName==='IMG';}
  document.addEventListener('contextmenu',function(e){if(estPhoto(e))e.preventDefault();});
  document.addEventListener('dragstart',function(e){if(estPhoto(e))e.preventDefault();});
})();
